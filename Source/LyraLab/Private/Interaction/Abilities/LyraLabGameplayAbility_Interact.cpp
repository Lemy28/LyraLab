                                                       ...
                                                       const FGameplayEventData* TriggerEventData)
{
	...
	if (AbilitySystem && AbilitySystem->GetOwnerRole() == ENetRole::ROLE_Authority)
	{
		UAbilityTask_GrantNearbyInteraction* Task = UAbilityTask_GrantNearbyInteraction::GrantNearbyInteraction(this, InteractionScanRate, InteractionScanRange);
